        ...
        html = string.concat(html,
            '<div class="w"><div class="s">',
                ...
                '<script>',
                    ...
                    '    tooltip.style.top = clientRect.top + document.body.scrollTop + flower.clientHeight + "px";',
                    '    const leftPos = clientRect.left + document.body.scrollLeft;',
                    ...
                    '}',
                    'async function fetchFlower(flowerId) {',
